package com.dassaultsystemes.searchengine.models;
...
import static com.dassaultsystemes.searchengine.common.Constants.STORAGE;
...
public class Document {
    ...
    private Lemmatizer lemmatizer = new Lemmatizer(DEFAULT_STOP_WORDS_FILE_PATH);
    ...
    public Document(String filename, HashMap<String, List<Integer>> vocabulary) throws FileNotFoundException {
        this.filepath = STORAGE+"/data/originalFiles/"+filename+".txt";
        this.name = filename;
    ...
    public List<String> foundLines(HashSet numberOfFoundLines) throws FileNotFoundException {
        ...
        Scanner scan = new Scanner(new File(STORAGE +"/data/originalFiles/"+this.name+".txt"));
        String line = "";
        int numberOfLine = 0;
